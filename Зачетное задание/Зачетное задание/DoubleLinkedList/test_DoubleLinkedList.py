...
class TestCase(unittest.TestCase):
    ...
    def test_set_ll(self): # если не использовать стр то и из и иквал выдают ошибку!
        ...
        ll = LinkedList(['a', 'b', 'c'])
        ll.__setitem__(1, 's')
        self.assertEqual(str(LinkedList(['a', 's', 'c'])), str(ll))
    ...
    # def test_insert_ll_out(self): # уточнить как работает
    #     ll = LinkedList(['a', 'b', 'c'])
    #     ll.insert(10, 's')
    #     self.assertRaises(IndexError)
    #
    # def test_insert_dll_out(self): # уточнить как работает
    #     dll = DoubleLinkedList(['a', 'b', 'c'])
    #     dll.insert(10, 's')
    #     self.assertRaises(IndexError)
    ...
    def test_centralnode_dll(self):
        ...
        dll = DoubleLinkedList(['a', 'b', 'c'])
        self.assertEqual('DoubleLinkedNode(b, DoubleLinkedNode(c), DoubleLinkedNode(a))', repr(dll.step_by_step_on_nodes(1)))
